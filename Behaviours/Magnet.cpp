...
m_xAngleSpeed(Random::GetFloat(0.0f, MathUtils::PI * 0.5f)),
m_yAngle(Random::GetFloat(0.0f, MathUtils::PI * 2.0f)),
m_yAngleSpeed(Random::GetFloat(0.0f, MathUtils::PI * 0.5f)),
m_zAngle(Random::GetFloat(0.0f, MathUtils::PI * 2.0f)),
m_zAngleSpeed(Random::GetFloat(0.0f, MathUtils::PI * 0.5f)),
m_pivot(nullptr)
{
}
